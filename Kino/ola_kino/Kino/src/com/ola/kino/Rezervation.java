...
public class Rezervation {
    public static final String ANSI_RED = "\u001B[31m";
            ...
            while ((filled <48) &&(input.length() >0)) {
                ...
                if (row<0 || row>8 || col<0 || col>6) {
                    System.out.println("Mejsce jest zajęnte , " +
                            "lub podane nie prawidlowy nymer miejsca dsdss.");
        ...
        private static void printSeats(char[][] seats) {
            ...
            System.out.println("There are XX number of seats available."); //Here I want the program to count available seats everytime the seating chart is updated.
        }
    }
...
//
//
//        ArrayList<Integer> ticket_res = new ArrayList<>(bookTickets.ticket_qty());
//
//        int prices= 40;
//
//        amount = prices;
...
//        return ticket_qty;
//    }
//    public static String tickets_res()
//    {
//        return tickets_res();
//    }
//
